...
public class AccountHolderOjects {
	...
	public static void main(String[] args) {
		...
		System.out.println("The average grade in the class is "+(john.gradepoints+hamid.gradepoints+tracy.gradepoints+albert.gradepoints+ana.gradepoints)/5+" and the average grade is B-.");
